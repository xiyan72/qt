...
static const string keys = "{ help h   |   | print help }"
                           "{ imgpositionwrite ipr |/home/xiyan/Downloads/ | clientid/orgid/tableid/recordid }"
                           ...
                           "{ image_designed  id | d1.jpg   | image from designer uploaded or from product defination,must be 'd1' started or same as content in txtbox 'designer iamge'}"
                           "{ image_designmodified idm | dm1.jpg  | image from designer uploaded or from product defination.must be 'dm1' started or same as content in txtbox 'designer modified iamge'}"
                           "{ diffthreshold dt   |  3 | 1 to 5 }"
                           "{ comparemethod cm   |  2 | 1 design to design,2 design to scan by feature,3 scan to scan .all decided by user list selection}"
